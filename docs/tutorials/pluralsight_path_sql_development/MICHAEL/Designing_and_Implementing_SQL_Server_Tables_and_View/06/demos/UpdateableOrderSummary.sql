...
-- Change Trillian's order to expedited
  -- fails because you have a derived column, a column calculated from an expression
...
-- Change the order date of order 1
  -- violates rule can't be modified by GROUP BY,HAVING,DISTINCT,PIVOT or UNPIVOT clauses
