...
CREATE TABLE Orders.Orders (
    ...
    CONSTRAINT PK_Orders_OrderYear_OrderID
        PRIMARY KEY (OrderYear, OrderID)                    -- New Primary Key as required by partitioned views
);
...
CREATE TABLE Orders.OrderItems (
    ...
    CONSTRAINT FK_OrderItems_OrderYear_OrderId_Orders   -- New Foreign Key constraint
        FOREIGN KEY (OrderYear, OrderId) -- this is how you reference 2 more columns for a key
